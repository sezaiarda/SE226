...
def q1() -> None:
    ...
    _print_words(words, "e")
    _print_words(words, "ha")


def _print_words(words: list[str], start_with: str) -> None:
    print(f"The words starts with letter {start_with}:")
    for word in words:
